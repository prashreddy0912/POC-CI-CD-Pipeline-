...
resource "aws_codepipeline" "ecs_pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        Owner      = "prashreddy0912" # Replace with your GitHub username
        Repo       = "POC-CI-CD-PIPELINE"      # Replace with your GitHub repository name
        Branch     = "main"                # Replace with your branch name
        OAuthToken = var.github_oauth_token # GitHub OAuth token stored in Terraform variables
      }
    }
  }
